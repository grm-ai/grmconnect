        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-card border border-border rounded-2xl p-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="At least 6 characters" className="h-10 pl-9 text-sm" autoComplete="new-password" />
            </div>
          </div>
